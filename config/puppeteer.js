...
module.exports.ibriLogin = function(sendData, userID) {
            ...
            try {
                ...
                try {
                    ...
                    if((await page.$('a[id="myaccounts"]')) !== null || (await page.$('a[href="Logout.html"]')) !== null){
                        ...
                        await page.waitForTimeout({ timeout: timeout, waitUntil: 'domcontentloaded'});
                        ...
                        try {
                            ...
                            await frame.click('a[href="AccountStatement.html"]', { timeout: timeout, waitUntil: 'domcontentloaded' });
                        } catch (err) {
                            console.log("LOG : " + err);
                        ...
                        try {
                            // find content after click accountstatement
                            frame = await page.frames().find(fr => fr.name() === 'content');
                            await frame.waitForSelector('#divToPrint > div > table').then(() => 
                                console.log('LOG : all page loaded')
                            );
